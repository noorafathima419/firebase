...
class Growcery extends StatefulWidget {
  const Growcery({super.key});

  @override
  State<Growcery> createState() => _GrowceryState();
}

class _GrowceryState extends State<Growcery> {
  @override
          ...
          Expanded(
            child: StreamBuilder(
              stream: FirebaseFirestore.instance
                  ...
                  .where("Cattegory", isEqualTo: "Grocery")
                  .snapshots(),
